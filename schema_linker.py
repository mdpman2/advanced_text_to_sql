...
class SchemaLinker:
    ...
    # 한국어 키워드 매핑 (클래스 레벨 상수)
    KOREAN_KEYWORDS: Dict[str, List[str]] = {
        # 집계 함수
        "평균": ["AVG", "average"],
        "합계": ["SUM", "total"],
        "개수": ["COUNT", "number"],
        "최대": ["MAX", "maximum", "highest"],
        "최소": ["MIN", "minimum", "lowest"],
    ...
    # 일반적인 엔티티-테이블 매핑
    ENTITY_PATTERNS = {
        "직원": ["employee", "employees", "staff", "worker", "workers", "emp"],
        "부서": ["department", "departments", "dept", "division"],
        "프로젝트": ["project", "projects", "proj"],
        "고객": ["customer", "customers", "client", "clients"],
        "주문": ["order", "orders", "purchase", "purchases"],
        "제품": ["product", "products", "item", "items"],
        "판매": ["sale", "sales", "transaction", "transactions"],
        "매출": ["revenue", "sales", "income"],
        "급여": ["salary", "salaries", "wage", "wages", "pay"],
        "연봉": ["salary", "annual_salary", "yearly_pay"],
    }
